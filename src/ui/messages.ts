...
const MESSAGES: Record<AnyRefusal, string> = {
  ...
  'chevauchement': 'Le cadastre fait se chevaucher ce bâtiment et une construction légère voisine, au lieu de les faire se toucher. La fusion ne peut pas être exacte ; à tracer à la main.',
